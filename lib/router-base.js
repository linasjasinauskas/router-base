(function (global) {
     ...
     * @param {Function} options.generateQuery
    ...
    var RouterBase = function (options) {
         ...
         * @private
         */
        this._generateQuery = options.generateQuery || this._defaultGenerateQuery;
    };
     ...
     * @protected
     */
    RouterBase.prototype._defaultGenerateQuery = function (params) {
        var query = '';
        for (var key in params) {
            if (params.hasOwnProperty(key)) {
